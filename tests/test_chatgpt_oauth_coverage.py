...
class TestHandleChatgptStatus:
    def test_authenticated_with_key(self):
        ...
        with (
            ...
            patch(
                "code_puppy_core_plugins.chatgpt_oauth.register_callbacks.load_chatgpt_models",
    ...
    def test_authenticated_no_key(self):
        ...
        with (
            ...
            patch(
                "code_puppy_core_plugins.chatgpt_oauth.register_callbacks.emit_warning"
            ),
        ):
            _handle_chatgpt_status()
...
class TestHandleCustomCommand:
    ...
    def test_auth(self):
        ...
        with (
            patch(
                "code_puppy_core_plugins.chatgpt_oauth.register_callbacks.run_oauth_flow"
            ),
            patch(
                "code_puppy_core_plugins.chatgpt_oauth.register_callbacks.set_model_and_reload_agent"
            ),
        ):
    ...
    def test_status(self):
        ...
        with patch(
            "code_puppy_core_plugins.chatgpt_oauth.register_callbacks._handle_chatgpt_status"
        ):
    ...
    def test_logout(self):
        ...
        with patch(
            "code_puppy_core_plugins.chatgpt_oauth.register_callbacks._handle_chatgpt_logout"
        ):
...
class TestCreateChatgptOauthModel:
    def test_no_access_token(self):
        ...
        with (
            patch(
                "code_puppy_core_plugins.chatgpt_oauth.register_callbacks.get_valid_access_token",
                return_value=None,
            ),
            patch(
                "code_puppy_core_plugins.chatgpt_oauth.register_callbacks.emit_warning"
